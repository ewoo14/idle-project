...
| M2 | [M2-skill-rank-points-v1.md](M2-skill-rank-points-v1.md) | Skill rank points, level-up grants, MaxRank 50, effective damage/cooldown, HUD rank state |
...
| M6 | [M6-boss-patterns-hud-v1.md](M6-boss-patterns-hud-v1.md) | Boss HP bar, phase label, special attack warning, and HUD regression coverage |
