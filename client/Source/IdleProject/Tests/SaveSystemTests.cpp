...
bool FIdleSaveGameDefaultsTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("SaveVersion starts at V22"), SaveGame->SaveVersion, static_cast<int32>(22));
...
bool FIdleSaveSystemApplyCaptureRoundTripTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Captured save writes V22"), CapturedSave->SaveVersion, static_cast<int32>(22));
...
bool FIdleSaveSystemLegacyV7StageMigrationTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Capture after legacy migration writes V22"), CapturedSave->SaveVersion, static_cast<int32>(22));
...
bool FIdleSaveSystemMasteryV12MigrationTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Migrated capture writes v22"), CapturedSave->SaveVersion, static_cast<int32>(22));
...
bool FIdleSaveSystemConsumableV13MigrationTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Migrated consumable capture writes v22"), CapturedSave->SaveVersion, static_cast<int32>(22));
...
bool FIdleSaveSystemConsumableGradeV15MigrationTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("v15 grade migration capture writes v22"), CapturedSave->SaveVersion, static_cast<int32>(22));
...
bool FIdleSaveSystemWeeklyBossV14MigrationTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Migrated weekly boss capture writes v22"), CapturedSave->SaveVersion, static_cast<int32>(22));
