...
bool FIdleSaveGameDefaultsTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("SaveVersion starts at V21"), SaveGame->SaveVersion, static_cast<int32>(21));
...
bool FIdleSaveSystemApplyCaptureRoundTripTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Captured save writes V21"), CapturedSave->SaveVersion, static_cast<int32>(21));
...
bool FIdleSaveSystemLegacyV7StageMigrationTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Capture after legacy migration writes V21"), CapturedSave->SaveVersion, static_cast<int32>(21));
...
bool FIdleSaveSystemMasteryV12MigrationTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Migrated capture writes v21"), CapturedSave->SaveVersion, static_cast<int32>(21));
...
bool FIdleSaveSystemConsumableV13MigrationTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Migrated consumable capture writes v21"), CapturedSave->SaveVersion, static_cast<int32>(21));
...
bool FIdleSaveSystemConsumableGradeV15MigrationTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("v15 grade migration capture writes v21"), CapturedSave->SaveVersion, static_cast<int32>(21));
...
bool FIdleSaveSystemWeeklyBossV14MigrationTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Migrated weekly boss capture writes v21"), CapturedSave->SaveVersion, static_cast<int32>(21));
