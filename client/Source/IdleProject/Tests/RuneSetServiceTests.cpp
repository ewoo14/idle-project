...
bool FRuneSetGameInstanceSaveVersionTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Default save version is current (22) for rune sets"), SaveGame->SaveVersion, 22);
	...
	TestEqual(TEXT("Captured save version is current (22)"), CapturedSave->SaveVersion, 22);
