...
bool FRuneSetGameInstanceSaveVersionTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Default save version is current (27) for rune sets"), SaveGame->SaveVersion, 27);
	...
	TestEqual(TEXT("Captured save version is current (27)"), CapturedSave->SaveVersion, 27);
