...
bool FRuneSetGameInstanceSaveVersionTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Default save version is current (26) for rune sets"), SaveGame->SaveVersion, 26);
	...
	TestEqual(TEXT("Captured save version is current (26)"), CapturedSave->SaveVersion, 26);
