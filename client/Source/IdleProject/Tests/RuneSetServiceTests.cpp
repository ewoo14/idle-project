...
bool FRuneSetGameInstanceSaveVersionTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Default save version is current (19) for rune sets"), SaveGame->SaveVersion, 19);
	...
	TestEqual(TEXT("Captured save version is current (19)"), CapturedSave->SaveVersion, 19);
