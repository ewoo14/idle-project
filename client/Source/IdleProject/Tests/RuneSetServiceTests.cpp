...
bool FRuneSetGameInstanceSaveVersionTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Default save version is current (24) for rune sets"), SaveGame->SaveVersion, 24);
	...
	TestEqual(TEXT("Captured save version is current (24)"), CapturedSave->SaveVersion, 24);
