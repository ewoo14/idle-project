...
bool FRuneSetGameInstanceSaveVersionTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Default save version is ten for rune sets"), SaveGame->SaveVersion, 10);
	...
	TestEqual(TEXT("Captured save version is ten"), CapturedSave->SaveVersion, 10);
