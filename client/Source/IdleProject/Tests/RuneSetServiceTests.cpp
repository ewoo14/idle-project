...
bool FRuneSetGameInstanceSaveVersionTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Default save version is current (18) for rune sets"), SaveGame->SaveVersion, 18);
	...
	TestEqual(TEXT("Captured save version is current (18)"), CapturedSave->SaveVersion, 18);
