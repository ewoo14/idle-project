...
bool FRuneSetGameInstanceSaveVersionTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Default save version is current (23) for rune sets"), SaveGame->SaveVersion, 23);
	...
	TestEqual(TEXT("Captured save version is current (23)"), CapturedSave->SaveVersion, 23);
