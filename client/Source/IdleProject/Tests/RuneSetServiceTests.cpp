...
bool FRuneSetGameInstanceSaveVersionTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Default save version is current (25) for rune sets"), SaveGame->SaveVersion, 25);
	...
	TestEqual(TEXT("Captured save version is current (25)"), CapturedSave->SaveVersion, 25);
