...
bool FRuneSetGameInstanceSaveVersionTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Default save version is current (17) for rune sets"), SaveGame->SaveVersion, 17);
	...
	TestEqual(TEXT("Captured save version is current (17)"), CapturedSave->SaveVersion, 17);
