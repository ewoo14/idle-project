...
bool FHudNavCategoryRegistryTest::RunTest(const FString& Parameters)
{
    ...
    TestEqual(TEXT("first is Combat"), (int32)Cats[0], (int32)EHudCategory::Combat);
    TestEqual(TEXT("last is Social"), (int32)Cats[6], (int32)EHudCategory::Social);
    ...
    for (const EHudCategory Cat : Cats)
    {
        ...
        {
            TestEqual(TEXT("panel maps back to its category"), (int32)CategoryForPanel(Panel), (int32)Cat);
        }
    }
    int32 Total = 0;
