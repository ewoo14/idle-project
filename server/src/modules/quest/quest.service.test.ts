...
describe("QuestService", () => {
  it("mirrors the expanded client quest definition table", () => {
    expect(
      ...
      {
        questId: "main_ch9_001",
        type: "main",
        objective: "kill_monster",
        targetCount: 130,
        rewardGold: 615000,
        rewardExp: 461000,
        prerequisiteQuestId: "main_ch8_006",
        chapterMapId: "9-1",
      },
      {
        questId: "main_ch9_002",
        type: "main",
        objective: "clear_map",
        targetCount: 1,
        rewardGold: 695000,
        rewardExp: 521000,
        prerequisiteQuestId: "main_ch9_001",
        chapterMapId: "9-2",
      },
      {
        questId: "main_ch9_003",
        type: "main",
        objective: "reach_level",
        targetCount: 105,
        rewardGold: 785000,
        rewardExp: 588000,
        prerequisiteQuestId: "main_ch9_002",
        chapterMapId: "9-4",
      },
      {
        questId: "main_ch9_004",
        type: "main",
        objective: "climb_tower",
        targetCount: 60,
        rewardGold: 887000,
        rewardExp: 665000,
        prerequisiteQuestId: "main_ch9_003",
        chapterMapId: "9-5",
      },
      {
        questId: "main_ch9_005",
        type: "main",
        objective: "kill_monster",
        targetCount: 185,
        rewardGold: 1002000,
        rewardExp: 752000,
        prerequisiteQuestId: "main_ch9_004",
        chapterMapId: "9-8",
      },
      {
        questId: "main_ch9_006",
        type: "main",
        objective: "defeat_boss",
        targetCount: 1,
        rewardGold: 1179000,
        rewardExp: 884000,
        prerequisiteQuestId: "main_ch9_005",
        chapterMapId: "9-10",
      },
      {
  ...
  it("unlocks and progresses chapter six main quests through existing objective hooks", async () => {
    ...
    const killResults = await killService.addProgressForObjective(
      userId,
      characterId,
      { objective: "kill_monster", amount: 125 },
    );
    ...
    const levelResults = await levelService.addProgressForObjective(
      userId,
      characterId,
      { objective: "reach_level", amount: 75 },
    );
    const towerResults = await towerService.addProgressForObjective(
      userId,
      characterId,
      { objective: "climb_tower", amount: 45 },
    );
    const bossResults = await bossService.addProgressForObjective(
      userId,
      characterId,
