...
describe("drop formulas", () => {
  it("keeps rarity stat multipliers aligned with FDropFormula", () => {
    ...
    expect(getRarityStatMultiplier("Uncommon")).toBe(1.3);
    expect(getRarityStatMultiplier("Rare")).toBe(1.7);
    expect(getRarityStatMultiplier("Epic")).toBe(2.3);
    expect(getRarityStatMultiplier("Legendary")).toBe(3.2);
  });
